...
<body>
    ...
    <div class="panel">
        <h1>Panel del <span>Instructor</span></h1>
    </div>
    ...
    <button>Crear Curso</button>
        ...
        WHERE instructor_id = ? ";
                        ...
                        <button name="boton" type="submit" style="background-color: #FF5733; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Agregar Lección</button>
                    </form>
                </div>
            </div>
